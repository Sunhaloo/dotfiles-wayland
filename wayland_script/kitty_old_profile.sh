...
change_font() {
    ...
    printf "\nOption [2]: CaskaydiaMono Nerd Font Mono\n\n"
    ...
    # if user wants "Iosevka Nerd Font Mono"
        ...
        # replace font with Iosevka Nerd Font Mono
		sed -i 's/^font_family\s\+family="\(JetBrainsMono Nerd Font\|Iosevka Nerd Font Mono\)"/font_family      family="CaskaydiaMono Nerd Font Mono"/' "$kitty_conf"
        # output confirmation message
        printf "\nFont changed to CaskaydiaMono Nerd Font Mono\n"
